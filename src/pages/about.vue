<template>
  ...
  >
    ...
    <div
      class="min-h-screen bg-ipmugo-neutral-100/30 dark:bg-ipmugo-neutral-10/30 backdrop-blur-sm min-w-full"
    >
      <div class="container z-10 px-4 mx-auto py-12">
        <!-- Hero banner -->
        <div
          class="grid py-12 grid-cols-1 md:grid-cols-2 gap-4 items-center overflow-hidden rounded-md"
        >
          <div>
            <h1
              class="text-h1 leading-h1 font-bold dark:text-ipmugo-neutral-100 text-ipmugo-neutral-10"
            >
              About Me
            </h1>
            <p
              class="text-p-18 leading-p-18 mt-4 dark:text-ipmugo-neutral-100 text-ipmugo-neutral-10"
            >
              We are a company dedicated to publishing the best articles in
              various fields. We believe that everyone has valuable ideas and
              insights to share, and we are committed to providing a platform
              for writers to express their ideas to a wide audience. Our team of
              experienced editors and reviewers works closely with writers to
              produce high-quality articles that inform, inspire, and engage
              readers. We strive to make a positive impact on the world through
              the articles we publish, and we are always looking for talented
              writers to join our community.
            </p>
            <NuxtLink
              to="/contact"
              class="h-11 mt-4 px-4 transition-all duration-300 ease-in-out bg-ipmugo-primary-50 text-ipmugo-neutral-100 rounded-md flex justify-center items-center gap-x-2 hover:bg-ipmugo-primary-20 focus:ring-2 ring-ipmugo-primary-80 flex-nowrap w-max"
              >Contact Me</NuxtLink
            >
          </div>
          <div
            class="flex justify-center items-center min-w-full min-h-full overflow-hidden rounded-md"
          ></div>
        </div>
        ...
        <div
          class="py-12 grid md:grid-cols-2 items-center gap-8 justify-between min-w-full"
        >
          <div>
            <h1
              class="text-h4 md:text-h3 lg:text-h2 leading-h4 md:leading-h3 lg:leading-h2 font-semibold pb-4 dark:text-ipmugo-neutral-100 text-ipmugo-neutral-10"
            >
              Explore Our
              <span class="text-ipmugo-primary-50">IPMUGO Digital Library</span>
            </h1>
            <p
              class="text-p-16 leading-p-16 md:w-[80%] dark:text-ipmugo-neutral-100 text-ipmugo-neutral-10"
            >
              Our digital library boasts thousands of daily visitors accessing
              expertly written articles from our growing collection, and
              hundreds of thousands of monthly downloads. Join us in building a
              better digital library for all.
            </p>
          </div>
