      ...
      <div class="container z-10 px-4 mx-auto lg:py-8">
        ...
        >
          <div>
            ...
            >
              Explore the world's <br />best
              <span class="text-ipmugo-primary-50">research</span>
            </h1>
            <p
        ...
        <div class="py-12 transition-all duration-300 ease-in-out">
          ...
          <p
            class="text-p-16 leading-p-16 text-ipmugo-neutral-10 dark:text-ipmugo-neutral-100"
          >
            Get to know the experts behind the research, and discover their
            latest publications.
          </p>
        ...
        <div class="py-12 transition-all duration-300 ease-in-out">
          <h2
            class="text-h4 md:text-h3 lg:text-h2 leading-h4 md:leading-h3 lg:leading-h2 font-semibold pb-4 text-ipmugo-neutral-10 dark:text-ipmugo-neutral-100 transition-all duration-300 ease-in-out"
          >
            Featured Articles
          </h2>
          <p
            class="text-p-16 leading-p-16 text-ipmugo-neutral-10 dark:text-ipmugo-neutral-100"
          >
            Explore our selection of top research articles from various fields.
          </p>

          <div
            class="grid grid-cols-1 md:grid-cols-3 justify-center gap-4 mt-8 transition-all duration-300 ease-in-out"
          >
            <div
        ...
        <div class="py-12 transition-all duration-300 ease-in-out">
          <h2
            class="text-h4 md:text-h3 lg:text-h2 leading-h4 md:leading-h3 lg:leading-h2 font-semibold pb-4 text-ipmugo-neutral-10 dark:text-ipmugo-neutral-100"
          >
            Insights and Perspectives <br />from Industry Experts.
          </h2>
          <p
            class="text-p-16 leading-p-16 text-ipmugo-neutral-10 dark:text-ipmugo-neutral-100"
          >
            Get in-depth analysis and thought-provoking articles from thought
            leaders in your field.
          </p>

          <div
            class="mt-8 h-full flex flex-col md:flex-row gap-x-6 items-center"
          >
            <div
              class="rounded-md hover:shadow-md cursor-pointer hover:-mt-4 h-full overflow-hidden transition-all duration-300 ease-in-out"
            >
              <figure class="h-56 overflow-hidden relative">
                <nuxt-link to="/">
                  <img
                ...
                >
                  <span class="text-ipmugo-primary-50 font-semibold"
                    >Engineering</span
                  >
                  <span class="ml-1">January 01, 2023</span>
                </div>
              </figure>
              <div class="p-4">
                <nuxt-link
                  ...
                  class="text-h4 leading-h4 font-semibold line-clamp-2"
                >
                  A low exposure photograph of an unsoldered Printed Circuit
                  Board (PCB) with ENIG (Gold) finish.
                </nuxt-link>
                <p class="text-p-14 mt-3 leading-p-14 line-clamp-2">
            ...
            <div class="flex flex-col gap-y-6">
              <div
                class="rounded-md hover:shadow-md cursor-pointer h-full grid grid-cols-1 md:grid-cols-4 justify-start items-start overflow-hidden transition-all duration-300 ease-in-out"
              >
                <figure class="md:col-span-1 h-full overflow-hidden relative">
                  <nuxt-link to="/"
                    ><img
                      src="https://images.unsplash.com/photo-1592659762303-90081d34b277?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=773&q=80"
                      alt=""
                ...
                <div class="p-4 md:col-span-3">
                  <div
                    class="px-1.5 py-1 mb-3 text-l-14 leading-l-14 rounded-md bg-ipmugo-primary-90 max-w-max"
                  >
                    <span class="text-ipmugo-primary-50 font-semibold"
                      >Engineering</span
                    >
                  ...
                  <nuxt-link
                    to="/"
                    class="text-h5 leading-h5 font-semibold line-clamp-2"
                  >
                    A low exposure photograph of an unsoldered Printed Circuit
                    Board (PCB) with ENIG (Gold) finish.
                  </nuxt-link>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async featuredArticle() {
      this.loading = true
      try {
        const data = await this.$axios.get('/api/article/featured-articles')
